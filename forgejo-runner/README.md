...
![Version: 0.4.32](https://img.shields.io/badge/Version-0.4.32-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 6.3.1](https://img.shields.io/badge/AppVersion-6.3.1-informational?style=flat-square)
...
| dind.image.tag | string | `"28.3.0-dind"` | image tag |
...
| kubectl.image.tag | string | `"1.33.1"` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
