...
![Version: 0.4.36](https://img.shields.io/badge/Version-0.4.36-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.0.0](https://img.shields.io/badge/AppVersion-7.0.0-informational?style=flat-square)
...
| dind.image.tag | string | `"28.3.1-dind"` | image tag |
...
| kubectl.image.tag | string | `"1.33.2"` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
