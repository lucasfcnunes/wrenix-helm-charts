...
helm.sh/chart: {{ include "headscale-ui.chart" . }}
...
*/}}
{{- define "headscale-ui.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "headscale-ui.fullname" .) .Values.serviceAccount.name }}
{{- else }}
