...
image::https://img.shields.io/badge/Version-0.1.27-informational?style=flat-square[Version: 0.1.27]
image::https://img.shields.io/badge/Version-application-informational?style=flat-square[Type: application]
image::https://img.shields.io/badge/AppVersion-2024.9.1-informational?style=flat-square[AppVersion: 2024.9.1]
== Maintainers
