...
image::https://img.shields.io/badge/Version-0.1.26-informational?style=flat-square[Version: 0.1.26]
image::https://img.shields.io/badge/Version-application-informational?style=flat-square[Type: application]
image::https://img.shields.io/badge/AppVersion-2024.9.0-informational?style=flat-square[AppVersion: 2024.9.0]
== Maintainers
