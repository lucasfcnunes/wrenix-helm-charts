...
![Version: 0.3.22](https://img.shields.io/badge/Version-0.3.22-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2025.4.4](https://img.shields.io/badge/AppVersion-2025.4.4-informational?style=flat-square)
...
| nats.image.tag | string | `"2.11.3-scratch"` |  |
...
| zigbee2mqtt.image.tag | string | `"2.3.0"` |  |
