...
image::https://img.shields.io/badge/Version-0.4.6-informational?style=flat-square[Version: 0.4.6]
...
| kubectl.image
| object
| `{"pullPolicy":"IfNotPresent","registry":"docker.io","repository":"bitnami/kubectl","tag":"1.31.3"}`
