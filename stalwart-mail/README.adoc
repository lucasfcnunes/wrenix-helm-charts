...
image::https://img.shields.io/badge/Version-0.0.16-informational?style=flat-square[Version: 0.0.16]
image::https://img.shields.io/badge/Version-application-informational?style=flat-square[Type: application]
image::https://img.shields.io/badge/AppVersion-0.10.4-informational?style=flat-square[AppVersion: 0.10.4]
== Maintainers
